...
export async function updateSkill(
	...
	await writeFile(
		skillFile,
		renderSkillDocument({ title, description, content }),
		"utf8",
	);
...
function parseSkillDocument(input: string): SkillDocumentParts {
...
function renderSkillDocument(input: SkillDocumentParts): string {
	return [
